...
| 4 | 텍스트 추가 | ✅ | ✅ | 위치/색/배경박스 |
| 5 | 업스케일링 | ✅ | ✅ | 2x/3x/4x + 샤픈 |
| 6 | 워터마크 제거 | ❌ | ✅ | OpenCV inpainting (로컬 전용) |
| 7 | 배경 제거 | ❌ | ✅ | rembg U²-Net AI 176MB (로컬 전용) |
| 8 | 사람 제거 | ❌ | ✅ | rembg + inpainting (로컬 전용) |

> 무거운 AI 처리(6~8)는 모델 크기와 연산량 때문에 브라우저에서 실행할 수 없습니다.
> 웹에서 해당 버튼을 누르면 자동으로 로컬 설치 안내가 표시됩니다.
